...
# # Load the image
# image = cv2.imread("/Users/soumyaprasadchandra/Downloads/card.png")

# # Detect the watermark text using OCR
...
#     bbox = np.array(detection[0]).astype(np.int32)
#     cv2.fillPoly(mask, [bbox], (255, 255, 255))

# # Inpaint the masked area
# inpainted_image = cv2.inpaint(image, mask, cv2.INPAINT_TELEA)
...
# # from aspose.imaging import Image, WatermarkRemover, ContentAwareFillWatermarkOptions, Rectangle

# # # Load the image
# # image = Image.load("/Users/soumyaprasadchandra/Downloads/card.png")

# # # Define the watermark area
# # watermark_area = Rectangle(100, 100, 200, 50) 

# # # Create watermark removal options
# # options = ContentAwareFillWatermarkOptions(watermark_area)

# # # Remove the watermark
# # watermark_remover = WatermarkRemover(image)
# # watermark_remover.remove(options)

# # # Save the result
# # image.save("/Users/soumyaprasadchandra/Downloads/card2.png")
...
images = convert_from_path('/Users/soumyaprasadchandra/Downloads/card_backgroung_remover/card.pdf')
